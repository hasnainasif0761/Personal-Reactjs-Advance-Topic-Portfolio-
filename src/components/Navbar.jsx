...
function Navbar() {
  ...
  return (
    <nav className={`w-full h-20 ${showBg ? 'bg-[#070f1c]' : 'bg-transparent'} transition-all duration-300 ease-in-out flex justify-between items-center px-5 fixed top-0 left-0`}>
     <div>
           <p className='text-white z-10 md:text-3xl text-lg logo_head tracking-widest'>&lt; <span className='text-yellow-400'>H</span>uzaifa /&gt;</p> 
     </div>
    ...
    {
        <ul className={`absolute top-0 transition-all duration-300 ease-in-out ${isOpen?'left-0':'-left-full'} w-full bg-black/50 h-screen md:hidden flex flex-col gap-4 justify-center items-center shadow-lg`}>
