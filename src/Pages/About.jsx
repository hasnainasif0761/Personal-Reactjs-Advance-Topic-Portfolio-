  ...
  return (
    <div id="about" className='w-full pt-10 pb-16 bg-[#0A101e] flex flex-col items-center'>
      ...
      <div className="relative mt-10 text-center px-4">
        <h1 className="absolute md:w-[700px] w-full md:flex hidden  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:text-[60px] text-[10px] md:text-[120px] font-[700] text-white/5 tracking-[8px] select-none">
          ABOUT ME
        </h1>
