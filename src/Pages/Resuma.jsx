function Resuma(){
    ...
    <div className="flex justify-center mt-4">
      ...
      <span className="w-16 h-0.5 bg-[#3a3d4f]"></span>
        ...
        <div className="w-full mt-[70px]  h-auto border border-4 mb-2 border-red-400 flex md:flex-row flex-col justify-center items-center">
          <div className="md:w-[40%] w-full border h-full md:pl-[0px] pl-5 md:mb-0 mb-3">
          ...
          <div className="md:w-[40%] w-full border border-red-400 h-auto  md:pl-[7px] pl-5">
            <div className="border flex mt-2 items-center justify-start md:pl-[1px]">
              <img src="/exp-icon.png" className="w-[40px] h-[33px]" />
              <h2 className="text-[37px] ml-2  text-white mt-1">Experience</h2>
            </div>
            <div className="flex group ml-3 mt-3">
              <div>
              <div className="border-gray-500 group-hover:border-yellow-400 group-hover:bg-yellow-400 transition-all duration-300 border-[1.7px] w-[10px] h-[10px] rounded-full"></div>
              <div className="w-[1px] ml-1 h-[175px] border border-gray-500 "></div>
              </div>
              <div className="border w-auto text-start h-[150px] pl-3 mt-2 p-1 pt-2">
                <h1 className="text-[20px] text-yellow-400">Frontend Web Developer</h1>
                <p className="text-gray-400 text-[18px] mt-3 font-[500] text-start">Jan 2026 – Present</p>
                <h1 className="text-[20px] mt-4 text-white">Personal Projects & Continuous Learning</h1>
                <p className="text-[15px] text-gray-400 text-justify traking-wider text-lg/[20px] capitalize max-w-[500px] mt-3 float-none">Built responsive and interactive web applications using HTML, CSS, JavaScript, and React.js. Focused on creating clean user interfaces, improving user experience, and developing scalable frontend solutions.</p>
              </div>
              </div>
            <div className="flex group ml-3 mt-[1px]">
              <div>
              <div className="border-gray-500 group-hover:border-yellow-400 group-hover:bg-yellow-400 transition-all duration-300 border-[1.7px] w-[10px] h-[10px] rounded-full"></div>
              <div className="w-[1px] ml-1 h-[175px] border border-gray-500 "></div>
              </div>
              <div className="border w-auto text-start h-auto pl-3 mt-2 p-1 pt-2">
                <h1 className="text-[20px] text-yellow-400">Full Stack Developer Intern</h1>
                <p className="text-gray-400 text-[18px] mt-3 font-[500] text-start">Jully 2023 – Jan 2024</p>
                <h1 className="text-[20px] mt-4 text-white">Nweb Solutions</h1>
                <p className="text-[15px] text-gray-400 text-justify traking-wider text-lg/[20px] capitalize max-w-[500px] mt-3 float-none">Developed a Point of Sale (POS) System using HTML, tailwindcss, PHP, JavaScript, and MySQL. Implemented inventory management, sales tracking, and database operations while ensuring a responsive and user-friendly experience.</p>
              </div>
              </div>
          </div>
        </div>
